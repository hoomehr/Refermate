...
| 26 | `aws-iam-no-policy-wildcards` | *HIGH* | _IAM policy should avoid use of wildcards and instead apply the principle of least privilege_ | `terraform/main.tf:507` | IAM policy document uses sensitive action 's3:GetObject' on wildcarded resource '0c3bf16a-2ca2-4e64-a7a5-0d54739dd971' |
| 27 | `aws-iam-no-policy-wildcards` | *HIGH* | _IAM policy should avoid use of wildcards and instead apply the principle of least privilege_ | `terraform/main.tf:507` | IAM policy document uses sensitive action 'logs:CreateLogGroup' on wildcarded resource 'arn:aws:logs:*:*:*' |
| 28 | `aws-iam-no-policy-wildcards` | *HIGH* | _IAM policy should avoid use of wildcards and instead apply the principle of least privilege_ | `terraform/main.tf:507` | IAM policy document uses sensitive action 's3:GetObject' on wildcarded resource '0c3bf16a-2ca2-4e64-a7a5-0d54739dd971' |
| 29 | `aws-iam-no-policy-wildcards` | *HIGH* | _IAM policy should avoid use of wildcards and instead apply the principle of least privilege_ | `terraform/main.tf:507` | IAM policy document uses sensitive action 'logs:CreateLogGroup' on wildcarded resource 'arn:aws:logs:*:*:*' |
